  ...
  if (!installPrompt) {
    return (
      <div className="flex flex-col bg-gray-50 border border-gray-200 rounded-md p-4 mb-4 gap-4">
        ...
        <div className="mt-4">
          <Button onClick={handleInstallClick} variant="outline" className="text-sm">
            安装应用
          </Button>
        </div>
      </div>
    ...
    <div className="bg-blue-50 border border-blue-200 rounded-md p-4 mb-4">
      <div className="flex">
        ...
        <div className="ml-3 flex-1">
          ...
          <div className="mt-4">
            <Button onClick={handleInstallClick} variant="outline" className="text-sm text-blue-800 bg-blue-100 hover:bg-blue-200">
              安装应用
            </Button>
          </div>
        </div>
