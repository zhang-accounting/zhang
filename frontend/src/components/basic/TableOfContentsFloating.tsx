...
import { DropdownMenuContent, DropdownMenuItem, DropdownMenuPortal, DropdownMenuSub, DropdownMenuSubContent, DropdownMenuSubTrigger } from '../ui/dropdown-menu';
      ...
      return (
        <>
          {isFile ?
            ...
            <DropdownMenuItem onClick={() => onChange(targetItem[ZHANG_VALUE]!)} >
              {key}
            </DropdownMenuItem>
            ...
            <DropdownMenuSub>
              ...
              <DropdownMenuPortal>
                <DropdownMenuSubContent>
                  {itemBuilder(targetItem, index + 1)}
                </DropdownMenuSubContent>
              </DropdownMenuPortal>
            </DropdownMenuSub>
