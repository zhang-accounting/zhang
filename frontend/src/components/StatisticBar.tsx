  ...
  return (
    <Group>
      ...
      <StatisticBox
        ...
        amount={data.statistic.monthIncome.summary.number}
        currency={data.statistic.monthIncome.summary.currency}
        negetive
      />
      <StatisticBox
        text={'CURRENT_MONTH_EXPENSE'}
        amount={data.statistic.monthExpense.summary.number}
        currency={data.statistic.monthExpense.summary.currency}
      />
    </Group>
  );
}
